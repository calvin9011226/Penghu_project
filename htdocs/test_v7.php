    ...
    <script>
        ...
        function routeDistance(route, points) {
            ...
            for (let i = 0; i < route.length; i++) {
                ...
                let to = points[route[(i + 1) % route.length]];
        ...
        function showNextRoute() {
            ...
            var end = optimizedRoute[(currentRouteIndex + 1) % optimizedRoute.length];
            var startPoint = start === 0 && userMarker ? userMarker.getPosition() : markers[start - 1].getPosition();
            var endPoint = end === 0 && userMarker ? userMarker.getPosition() : markers[end - 1].getPosition();
