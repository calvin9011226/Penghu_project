...
import ML
import Search                   #撰寫的模組套件
import Now_weather
import Filter                   #撰寫的模組套件
import Plan2MYSQL               #撰寫的模組套件
import FlexMessage              #撰寫的模組套件
...
#PHP_ngrok ="https://0ab4-61-231-181-83.ngrok-free.app"# 80
...
GOOGLE_FORM_URL = "https://docs.google.com/forms/d/e/1FAIpQLSdrW6eLE04Zzk-pmJ1vs-5ehlZbly3nLCcgGxQLcA7TpSXI2Q/viewform"#測試用表單
